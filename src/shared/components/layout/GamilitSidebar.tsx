 ...
 * @property {string} icon - Icon name (maps to lucide-react icons)
 */
 ...
 * @property {string} subtitle - Module subtitle (character name)
 * @property {React.ComponentType<any>} icon - Icon component
 * @property {number} progress - Progress percentage (0-100)
 * @property {boolean} isUnlocked - Whether module is accessible
 * @property {boolean} isCompleted - Whether module is completed
 */
 ...
 * @property {() => void} [onClose] - Callback when sidebar closes
 * @property {string} [currentPath] - Current active path
 * @property {SidebarModuleProgress[]} [moduleProgress] - Module progress data
 * @property {(path: string) => void} [onNavigate] - Navigation callback
 * @property {string} [className] - Additional CSS classes
 * @property {'student' | 'teacher' | 'admin'} [userRole] - User role for navigation
 */
 ...
 */
const getNavigationItems = (userRole: 'student' | 'teacher' | 'admin' = 'student'): NavigationItem[] => {
  const baseItems = [
    {
      id: 'dashboard',
      label: 'Dashboard',
      path: userRole === 'teacher' ? '/teacher/dashboard' : userRole === 'admin' ? '/admin/dashboard' : '/dashboard',
      icon: 'Home',
    },
  ];
 ...
 * @param {'detective' | 'success'} [props.variant='detective'] - Color variant
 ...
 * ```
 */
const GamilitSidebar: React.FC<GamilitSidebarProps> = ({
  isOpen,
  onClose,
  currentPath = '/dashboard',
   ...
   */
  const totalProgress = userRole === 'student' ?
    Math.round(moduleProgress.reduce((acc, module) => acc + module.progress, 0) / moduleProgress.length) :
    0;
