...
/**
 * BATAB Icon - Sergeant Shield
 * Inspired by Maya warrior shields and geometric patterns
 */
export const BatabIcon: React.FC<Omit<MayaIconProps, 'rank'>> = ({
  className = '',
  size = 24,
}) => (
  <svg
...
/**
 * HOLCATTE Icon - Lieutenant Star
 * Inspired by Maya star glyphs and astronomical symbols
 */
export const HolcatteIcon: React.FC<Omit<MayaIconProps, 'rank'>> = ({
  className = '',
  size = 24,
}) => (
  <svg
...
/**
 * GUERRERO Icon - Captain Medal
 * Inspired by Maya warrior glyphs and ceremonial medallions
 */
export const GuerreroIcon: React.FC<Omit<MayaIconProps, 'rank'>> = ({
  className = '',
  size = 24,
}) => (
  <svg
...
/**
 * MERCENARIO Icon - Master Crown
 * Inspired by Maya royal crowns and divine symbols
 */
export const MercenarioIcon: React.FC<Omit<MayaIconProps, 'rank'>> = ({
  className = '',
  size = 24,
}) => (
  <svg
...
export const MayaIcon: React.FC<MayaIconProps> = ({ rank, className, size = 24 }) => {
  switch (rank) {
    ...
    case 'BATAB':
      return <BatabIcon className={className} size={size} />;
    case 'HOLCATTE':
      return <HolcatteIcon className={className} size={size} />;
    case 'GUERRERO':
      return <GuerreroIcon className={className} size={size} />;
    case 'MERCENARIO':
      return <MercenarioIcon className={className} size={size} />;
    default:
      return <NacomIcon className={className} size={size} />;
  }
};
